...
<div class="layout">
  ...
  <div id="sidebar">
    <h2><span class="sidebar-logo"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 32 32" style="vertical-align:-2px;margin-right:5px"><rect x="7" y="5" width="18" height="22" rx="2" fill="none" stroke="#569cd6" stroke-width="2.2"/><line x1="11" y1="11" x2="21" y2="11" stroke="#569cd6" stroke-width="2" stroke-linecap="round"/><line x1="11" y1="15" x2="21" y2="15" stroke="#569cd6" stroke-width="2" stroke-linecap="round"/><line x1="11" y1="19" x2="17" y2="19" stroke="#569cd6" stroke-width="2" stroke-linecap="round"/></svg></span>autonotes <span class="sidebar-actions"><button id="filter-btn" onclick="toggleHideNoNotes()" title="노트 없는 파일 숨기기">⊘<span class="filter-badge" id="filter-badge" style="display:none"></span></button><button id="toggle-btn" onclick="toggleSidebar()" title="사이드바 닫기">◀</button></span></h2>
