...
<div class="layout">
  ...
  <div id="sidebar">
    <h2><span class="sidebar-logo"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 512 512" style="vertical-align:-2px;margin-right:5px"><rect x="112" y="88" width="288" height="352" rx="20" fill="#252526" stroke="#569cd6" stroke-width="14"/><rect x="112" y="88" width="288" height="68" rx="20" fill="#2a3a4a"/><rect x="112" y="132" width="288" height="24" fill="#2a3a4a"/><rect x="154" y="112" width="128" height="14" rx="7" fill="#569cd6"/><rect x="154" y="196" width="204" height="14" rx="7" fill="#555"/><rect x="154" y="228" width="204" height="14" rx="7" fill="#555"/><rect x="154" y="260" width="204" height="14" rx="7" fill="#555"/><rect x="154" y="292" width="140" height="14" rx="7" fill="#555"/></svg></span>autonotes <span class="sidebar-actions"><button id="filter-btn" onclick="toggleHideNoNotes()" title="노트 없는 파일 숨기기">⊘<span class="filter-badge" id="filter-badge" style="display:none"></span></button><button id="toggle-btn" onclick="toggleSidebar()" title="사이드바 닫기">◀</button></span></h2>
